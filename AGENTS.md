...
- Do not permit duplicate execution for the same occurrence_key.
- Do not treat timezone as optional.
- Do not replace typed targets with arbitrary stringly execution blobs.
...
- maintain operator legibility
- add tests for invariants whenever behavior changes
- preserve append-only practical audit history
